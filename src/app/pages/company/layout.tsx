...
import { Gem, Home, Users, Pickaxe, UserRoundPen, CalendarDays, MessagesSquare, Globe, Key, LucideIcon,SquareCheckBig, Menu, Settings, X } from "lucide-react"
...
const SIDEBAR_ITEMS: SidebarCategory[] = [
  {
    category: "Dashboard",
    items: [
      { href: "/discover/discussions", icon: Globe, text: "Discussions" },
      { href: "/discover/groups", icon: Users, text: "Groups" },
      { href: "/discover/chats", icon: MessagesSquare, text: "Chats" },
      { href: "/discover/calendar", icon: CalendarDays, text: "Calendar" },
      { href: "/discover/tasks", icon: SquareCheckBig, text: "Tasks" },
    ],
  },
