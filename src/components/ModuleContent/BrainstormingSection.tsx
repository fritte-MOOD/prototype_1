...
import { BrainstormingModule, RelativeTime } from '@/data/interfaces';
...
const BrainstormingSection: React.FC<BrainstormingSectionProps> = ({ module }) => {
  ...
  return (
    <>
      <h3 className="text-2xl font-semibold mb-2">Brainstorming Module</h3>
      ...
      <h3 className="text-2xl font-semibold mb-2">Brainstorming Ideas:</h3>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-lg font-semibold">
                    {getUsernameById(option.createdBy)}: <span className="font-normal">{option.content}</span>
                  </p>
                  <p className="text-sm text-gray-600">
                    {renderDateTime(option.createdAt)}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Supported by: {option.supportedBy.map(id => getUsernameById(id)).join(', ')}
                  </p>
                </div>
              </div>
      ...
      <h3 className="text-xl font-semibold mb-4">Submit New Brainstorming Idea</h3>
